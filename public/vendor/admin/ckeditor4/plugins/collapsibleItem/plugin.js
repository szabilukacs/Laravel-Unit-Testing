        ...
        `<div class="panel panel-default collapsible-item" id="collapbsible-1">
           <div class="panel-heading collapsible-item-heading" role="tab" id="headingCollapbsible">
               <h4 class="panel-title collapsible-item-title">
                   <a class="collapsed collapsible-item-title-link-icon float-right" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseCollapbsible" aria-expanded="false" aria-controls="collapseCollapbsible"><span class="fas fa-plus">&nbsp;</span></a>
                   <a class="collapsed collapsible-item-title-link d-block" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseCollapbsible" aria-expanded="false" aria-controls="collapseCollapbsible"><span class="collapsible-item-title-link-text">Title Text</span></a>
               </h4>
           </div>
...
CKEDITOR.plugins.add('collapsibleItem', {
    ...
    onLoad: function () {
        CKEDITOR.addCss(
            ...
            '.collapsible-item::before {font-size:10px;color:#000;content: "Collapsible Item"}' +
